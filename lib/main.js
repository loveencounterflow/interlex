(function() {
  'use strict';
  var Grammar, Level, Lexeme, Stack, Token, _copy_regex, _default_flags_set, _disallowed_flags_set, _jsid_re, _jump_spec_back, _jump_spec_re, _normalize_new_flags, _normalize_regex_flags, _regex_flag_lower_re, _regex_flag_upper_re, _regex_flags_re, debug, hide, info, new_regex_tag, partial, regex, rpr, rx, slevithan_regex;
  ...
  //-----------------------------------------------------------------------------------------------------------
  _normalize_regex_flags = function(regex) {
    return _copy_regex(regex, _normalize_new_flags);
  };
