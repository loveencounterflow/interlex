(function() {
  'use strict';
  var Grammar, Internals, Level, Lexeme, Stack, Token, debug, hide, info, internals, new_regex_tag, rpr, rx;
  ...
  Grammar = class Grammar {
    ...
    //---------------------------------------------------------------------------------------------------------
    * walk_lexemes(source) {
      var f, fqname, jump, level, lexeme, new_level, snippet, stack, start, token;
      ({f} = require('../../effstring'));
      start = 0;
      ...
      while (true) {
        ...
        // debug 'Ωilx___9', lexeme.name, ( rpr lexeme.hit ), start is lexeme.stop
        start = lexeme.stop;
        if ((jump = lexeme.jump) == null) {
          // break if start is lexeme.stop
          //.....................................................................................................
          continue;
        }
        switch (jump.action) {
