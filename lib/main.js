(function() {
  'use strict';
  var Grammar, Internals, Level, Levelstack, Lexeme, Token, create, debug, hide, hide_getter, info, internals, isa, isa_optional, new_regex_tag, rpr, rx, set_getter, std, validate, validate_optional;
  ...
  Token = class Token {
    ...
    constructor(cfg) {
      ...
      hide(this, 'data_merge_strategy', (isa(std.function, cfg.merge)) ? 'call' : 'assign');
      return void 0;
    }
...
//.......................................................................................................
    ...
    * _scan_3_merge(source) {
      var active_fqname, buffer, flush, lexeme;
      buffer = [];
      active_fqname = null;
      //.......................................................................................................
      flush = function*() {
        var last_lexeme, lxm, merged_lexeme;
