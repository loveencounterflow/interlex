(function() {
  'use strict';
  var Grammar, Level, Lexeme, Stack, Token, _copy_regex, _jsid_re, _jump_spec_back, _jump_spec_re, _valid_regex_flag_lower_re, _valid_regex_flag_upper_re, _valid_regex_flags_re, debug, hide, info, new_regex_tag, partial, regex, rpr, rx;
  ...
  _copy_regex = function(regex, new_flags) {
    ...
    for (new_flag of new_flags) {
      switch (true) {
        case _valid_regex_flag_lower_re.test(new_flag):
          flags.add(new_flag);
          break;
        case _valid_regex_flag_upper_re.test(new_flag):
  ...
  */
  module.exports = {Token, Lexeme, Level, Grammar, regex, rx, new_regex_tag, _copy_regex, _jsid_re, _jump_spec_re, _valid_regex_flags_re};
