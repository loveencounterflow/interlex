(function() {
  'use strict';
  var Grammar, Level, Lexeme, Stack, Token, _copy_regex, _jsid_re, _jump_spec_back, _jump_spec_re, _regex_flag_lower_re, _regex_flag_upper_re, _regex_flags_re, debug, hide, info, new_regex_tag, partial, regex, rpr, rx;
  ...
  new_regex_tag = function(flags = 'dy') {
    ...
    return new Proxy(R, {
      get: function(target, key) {
        ...
        if (!_regex_flags_re.test(local_flags)) {
