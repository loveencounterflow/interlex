(function() {
  'use strict';
  var Grammar, Level, Lexeme, Token, _jump_literal_re, bind_instance_methods, debug, get_instance_methods, hide, info, partial, regex, rpr, rx;
...
\] (?<exclusive_back> [     .          ]  )     |
  ...
  Token = class Token {
    ...
    parse_jump(jump_literal) {
      ...
      /* TAINT use cleartype */
      if ((match = jump_literal.match(_jump_literal_re)) == null) {
  ...
  */
  module.exports = {Token, Lexeme, Level, Grammar, rx, _jump_literal_re};
